<footer>
<div class="footer2 container-felx fixed-bottom p-2 text-light bg-secondary"> 
    <div class="col-2">
...
<br>
    <div class= "container-felx fixed-bottom d-flex p-4 justify-content-end">
        ...
        <button class="buton" type="buton" class= "btn btn-info " onclick="document.location='question.php';">
            Klick
            <span style='font-size:50px;'>&#128512;</span>
        </button>
        </div>
